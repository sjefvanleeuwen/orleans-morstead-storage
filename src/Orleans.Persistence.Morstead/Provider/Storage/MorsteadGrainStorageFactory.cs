...
namespace Orleans.Storage
{
    ...
    /// </summary>
    public static class MorsteadGrainStorageFactory
    {
        public static IGrainStorage Create(IServiceProvider services, string name)
        {
            var optionsMonitor = services.GetRequiredService<IOptionsMonitor<MorsteadStorageOptions>>();
            return ActivatorUtilities.CreateInstance<MorsteadGrainStorage>(services, name, optionsMonitor.Get(name));
        }
    }
}
